    ...
    <div className="main">
      ...
      <div className='form'>
        ...
        {showResetPassButton && resetPassButton()}
          {!showResetPassButton && <Button variant="dark" className='button' onClick={() => setVerifyUser(true)}>Verify</Button>}
          {showResetPassButton && <Button variant="dark" className='button' onClick={() => setResetPass(true)}>Reset</Button>}
        </Form>
      </div>
